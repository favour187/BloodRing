...
public class PlayerController : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        {
            humanoidModel = ProceduralArt.CreateHumanoidMesh(charChoice == "DJNeon" ? "Striker" : (charChoice == "Pulse" ? "Tank" : "Stealth")); humanoidModel.transform.SetParent(transform); humanoidModel.transform.localPosition = Vector3.zero; rightArmTransform = humanoidModel.transform.Find("RightArm") ?? humanoidModel.transform;
        }
